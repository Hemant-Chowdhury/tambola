...
class TestTicketProcess(unittest.TestCase):
    ...
    def test_complete_game_process(self):
        ...
        self.assertTrue(ticket_1 in test_participant_1.tickets)
        self.assertTrue(ticket_2 in test_participant_2.tickets)
        self.assertTrue(test_participant_1 in test_group.participants)
        self.assertTrue(test_participant_2 in test_group.participants)
        self.assertTrue(test_group in game.groups)
    ...
    def test_new_game(self):
        ...
        self.assertFalse(ticket_1 in test_participant_1.tickets)
        self.assertFalse(ticket_2 in test_participant_2.tickets)
        self.assertTrue(test_participant_1 in test_group.participants)
        self.assertTrue(test_participant_2 in test_group.participants)
